...
void find_student(int n)
{
    ...
    int flag=0;
    printf("Enetr the Enrollment no you want to Search\n");
    scanf("%d",&enroll);
    ...
    if (flag == 1)
    {
        printf("Element Found at %d location in the database.\n",m+1);
    }
    else
    {
...
void list_student() //This function list all students in the system.
{
    printf("Student List :-\n");
    for (int j = 0; j <= i; j++)
    {
